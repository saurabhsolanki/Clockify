    ...
    <>
      <Box>
        ...
        <Box paddingTop="20px" width="90%" margin="auto" className="container">
          <Img
            ...
            src="https://clockify.me/assets/images/features/features-approval-screenshot.svg"
          />
        </Box>
      </Box>
      ...
      >
        <Box width="100%" marginTop="20px" align="center" mx="2">
          ...
          <Text color="gray">Submit timesheets with one click.</Text>
        </Box>
        <Box marginTop="20px" width="100%" align="center" mx="2">
          <Text fontSize={{ base: "20px", md: "20px", lg: "22px" }}>
            Reminders
          </Text>
          <Text color="gray">Send late timesheet reminders.</Text>
        </Box>
        <Box marginTop="20px" width="100%" align="center" mx="2">
          <Text fontSize={{ base: "20px", md: "20px", lg: "22px" }}>
            Immutable
          </Text>
          <Text color="gray">Prevent further changes.</Text>
        </Box>
        <Box marginTop="20px" width="100%" align="center" mx="2">
          <Text fontSize={{ base: "20px", md: "20px", lg: "22px" }}>
            History
          </Text>
          <Text color="gray">See all requests in one place.</Text>
        </Box>
      </Flex>
    </>
  );
