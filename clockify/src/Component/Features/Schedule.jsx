    ...
    <>
      <Box>
        ...
        <Box paddingTop="20px" width="90%" margin="auto" className="container">
          <Img
            ...
            src="https://clockify.me/assets/images/features/features-scheduling-projects-screenshot.svg"
          />
        </Box>
      </Box>
      ...
      >
        <Box width="100%" marginTop="20px" align="center" mx="2">
          ...
          <Text color="gray">Visualize projects on timeline.</Text>
        </Box>
        <Box marginTop="20px" width="100%" align="center" mx="2">
          <Text fontSize={{ base: "20px", md: "20px", lg: "22px" }}>
            Assignments
          </Text>
          <Text color="gray">Decide who works on what.</Text>
        </Box>
        <Box marginTop="20px" width="100%" align="center" mx="2">
          <Text fontSize={{ base: "20px", md: "20px", lg: "22px" }}>
            Capacity
          </Text>
          <Text color="gray">See who can take on more work.</Text>
        </Box>
        <Box marginTop="20px" width="100%" align="center" mx="2">
          <Text fontSize={{ base: "20px", md: "20px", lg: "22px" }}>
            Publish
          </Text>
          <Text color="gray">Let others see their assignments.</Text>
        </Box>
      </Flex>
    </>
  );
